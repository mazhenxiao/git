...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* 价格管理-签约 */
//兼容ie


//标签

var PriceContract = function (_React$Component) {
    _inherits(PriceContract, _React$Component);

    function PriceContract(arg) {
        _classCallCheck(this, PriceContract);

        // this.props.location.state;
        var _this = _possibleConstructorReturn(this, (PriceContract.__proto__ || Object.getPrototypeOf(PriceContract)).call(this, arg));
