...
var _componentStagingInformation = __webpack_require__(958);

var _componentStagingInformation2 = _interopRequireDefault(_componentStagingInformation);

var _componentIndicators = __webpack_require__(962);
    ...
    _createClass(Intallment, [{
        ...
        value: function evLandList(landArr) {
            ...
            if (th.state.status != "add") {
                var statedb = this.state.StagingInformationDATA;
                var arrs = statedb.STAGECODE.split("-");
                ...
                var _statedb = this.state.StagingInformationDATA;
                th.setState({
                    STAGECODE: _statedb.STAGECODE
                });
            }
...
var _componentStagingInformationGroupIframe = __webpack_require__(959);

var _componentStagingInformationGroupIframe2 = _interopRequireDefault(_componentStagingInformationGroupIframe);

var _componentStagingInformationPlateIframe = __webpack_require__(961);
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'td',
                                        null,
                                        _react2.default.createElement('input', { readOnly: 'true', id: 'STAGECODE', value: th.state.STAGECODE, className: 'inputTextBox inputGray boxSizing', type: 'text' })
                                    )
                                ),
                                _react2.default.createElement(
                                    'tr',
    ...
    _createClass(PlateIframe, [{
        ...
        value: function inputChange(ind, el, ev) {
            ...
            if (domType) {
                ...
                brr.forEach(function (el, ind) {
                    if (el.buildingName == text) {
                        el.pushPlateName = "推盘", el.pushPlateNumber = n, el.pushPlateId = idN, el.delete = "";
                    }
                });
                //console.log(brr)
                brr.forEach(function (el, ind) {
...
var _componentIndicatorsWinopen = __webpack_require__(937);
