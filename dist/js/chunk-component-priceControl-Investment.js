...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* 价格管理-投决会 */
//兼容ie


//标签

var PriceInvestment = function (_React$Component) {
    _inherits(PriceInvestment, _React$Component);

    function PriceInvestment(arg) {
        _classCallCheck(this, PriceInvestment);

        // this.props.location.state;
        var _this = _possibleConstructorReturn(this, (PriceInvestment.__proto__ || Object.getPrototypeOf(PriceInvestment)).call(this, arg));
...
exports.default = PriceInvestment;
