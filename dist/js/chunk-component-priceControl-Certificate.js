...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* 价格管理-工规证 */
//兼容ie


//标签

var PriceCertificate = function (_React$Component) {
    _inherits(PriceCertificate, _React$Component);

    function PriceCertificate(arg) {
        _classCallCheck(this, PriceCertificate);

        var _this = _possibleConstructorReturn(this, (PriceCertificate.__proto__ || Object.getPrototypeOf(PriceCertificate)).call(this, arg));
...
exports.default = PriceCertificate;
