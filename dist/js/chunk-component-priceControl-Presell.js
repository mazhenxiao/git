...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* 价格管理-预售证 */
//兼容ie


//标签

var PricePresell = function (_React$Component) {
    _inherits(PricePresell, _React$Component);

    function PricePresell(arg) {
        _classCallCheck(this, PricePresell);

        // this.props.location.state;
        var _this = _possibleConstructorReturn(this, (PricePresell.__proto__ || Object.getPrototypeOf(PricePresell)).call(this, arg));
