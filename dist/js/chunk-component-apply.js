...
var _toolsAgentyTab = __webpack_require__(1530);

var _toolsAgentyTab2 = _interopRequireDefault(_toolsAgentyTab);

var _toolsPage = __webpack_require__(1531);
...
var Apply = function (_React$Component) {
    ...
    function Apply(arg) {
        ...
        var _this = _possibleConstructorReturn(this, (Apply.__proto__ || Object.getPrototypeOf(Apply)).call(this, arg));

        _this.url = "/MyTodo/IGetmySubmition?page=1&size=10";
        _this.state = {
            dataList: []
        };
        return _this;
    ...
    _createClass(Apply, [{
        ...
        value: function EVENT_CLICK_PROJECTNAME(da) {
            ...
            if (da.runstate == "Rejected") {
                ...
                switch (da.entiid) {
                    case iss.getEVal("newProjectStatus"):
                        search = "?e=" + da.entiid + "&dataKey=" + da.runtrecordid + "&current=ProcessApprover";break; //项目
                    case iss.getEVal("intallmentStatus"):
                        search = "?e=" + da.entiid + "&dataKey=" + da.runtrecordid + "&current=ProcessApprover";break; //分歧
                }
                iss.hashHistory.push({
