...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* 价格管理-决策书 */
//兼容ie


//标签

var PriceDecision = function (_React$Component) {
    _inherits(PriceDecision, _React$Component);

    function PriceDecision(arg) {
        _classCallCheck(this, PriceDecision);

        // this.props.location.state;
        var _this = _possibleConstructorReturn(this, (PriceDecision.__proto__ || Object.getPrototypeOf(PriceDecision)).call(this, arg));
