...
var _toolsProcessBar = __webpack_require__(760);

var _toolsProcessBar2 = _interopRequireDefault(_toolsProcessBar);

var _toolsExchangeButton = __webpack_require__(761);
...
var _componentPriceControl = __webpack_require__(707);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* 价格管理-产品定位会 */
//兼容ie


//标签

var PriceProductlocat = function (_React$Component) {
    _inherits(PriceProductlocat, _React$Component);

    function PriceProductlocat(arg) {
        _classCallCheck(this, PriceProductlocat);

        // this.props.location.state;
        var _this = _possibleConstructorReturn(this, (PriceProductlocat.__proto__ || Object.getPrototypeOf(PriceProductlocat)).call(this, arg));
    ...
    _createClass(PriceProductlocat, [{
        key: "componentWillMount",
        value: function componentWillMount() {
            // render之前
        }
    ...
    return PriceProductlocat;
}(_react2.default.Component);

exports.default = PriceProductlocat;
