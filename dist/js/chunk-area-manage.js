...
var Index = function (_Component) {
    ...
    function Index() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.state = { //绑定数据
        ...
        }, _this.planQuotaUpdateData = [], _this.loadStep = function () {
            ...
            _services.AreaService.getStep(dataKey, mode).then(function (stepData) {
                ...
                if (step) {
                    return _services.AreaService.getVersion(step, dataKey, mode);
                }
                return Promise.reject("未获取到阶段数据！");
            }).then(function (versionData) {
                versionId = _this.getDefaultVersionId(versionData);
                _this.setState({
                    versionData: versionData,
                    versionId: versionId
                });
                _this.loadData(true, step, mode, dataKey, versionId);
            }).catch(function (error) {
                console.log("发生错误", error);
            });
        }, _this.loadData = function (isInit, step, mode, dataKey, versionId) {
            var versionId = versionId || _this.props.location.query["dataKey"];
            ...
            var allPromise = [];
            //获取规划方案指标数据
            var planQuotaPromise = _services.AreaService.getAreaPlanQuota(step, versionId);
            //获取地块·面积数据
            var blockPromise = _services.AreaService.getAreaList(step, mode, versionId);
            ...
            Promise.all(allPromise).then(function (_ref2) {
                var _ref3 = _slicedToArray(_ref2, 3),
                    planData = _ref3[0],
                    blockData = _ref3[1],
                    conditionData = _ref3[2];
            ...
            Promise.all(allPromise).then(function (_ref4) {
        ...
        }, _this.handleCreateVersion = function () {
            _this.setState({
                loading: true
            });
            var _this$state3 = _this.state,
                ...
                dataKey = _this$state3.dataKey;

            _services.AreaService.createVersion(step, dataKey, mode).then(function (result) {
                if (result === "success") {
                    console.log("版本创建成功");
                } else {
            ...
            return function () {
                ...
                _services.AreaService.getVersion(newStep, dataKey, mode).then(function (versionData) {
                    versionId = _this.getDefaultVersionId(versionData);
                    _this.setState({
                        versionData: versionData,
                        versionId: versionId
                    ...
                    _this.loadData(false, newStep, mode, dataKey, versionId);
                }).catch(function (error) {
                    _this.setState({
                        loading: false
                    });
        ...
        }, _this.handleModalClick = function (modalKey) {
        ...
        }, _this.handleHideModal = function (param) {
            var _this$state5 = _this.state,
                step = _this$state5.step,
                mode = _this$state5.mode,
                dataKey = _this$state5.dataKey,
                versionId = _this$state5.versionId;

            _this.setState({
                modalKey: ""
            });
            if (param == "reload") {
                _this.loadData(false, step, mode, dataKey, versionId);
            }
        }, _this.handleTabChange = function (activeTapKey) {
            _this.setState({ activeTapKey: activeTapKey });
        }, _this.handlePlanQuotaDataChange = function (postData) {
            _this.planQuotaUpdateData = postData || [];
            ...
            var _this$state6 = _this.state,
                step = _this$state6.step,
                stepData = _this$state6.stepData;
            ...
            if (step.guid < 3) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { type: 'button', className: 'jh_btn jh_btn22 jh_btn_add', onClick: _this.handleCreateVersion },
                            '\u751F\u6210\u65B0\u7248\u672C'
                        ),
                        _react2.default.createElement(
                            'button',
            ...
            var _this$state7 = _this.state,
                ...
                areaData = _this$state7.areaData,
                searchKey = _this$state7.searchKey;
            ...
            panelArray.push(_react2.default.createElement(
                ...
                _react2.default.createElement(_planQuota2.default, { planData: planData,
                    onPlanQuotaDataChange: _this.handlePlanQuotaDataChange })
            ));
            ...
            if (parseInt(step.guid) < 3) {
                ...
                panelArray.push(_react2.default.createElement(
                    ...
                    _react2.default.createElement(_comBlock2.default, { dataSource: blockData["areadataInfo"],
                        onBlockFormatClick: _this.handleModalClick("block-format-adjust"),
            ...
            var _this$state8 = _this.state,
                modalKey = _this$state8.modalKey,
                record = _this$state8.record,
                conditionData = _this$state8.conditionData,
                step = _this$state8.step,
                mode = _this$state8.mode,
                versionId = _this$state8.versionId,
                dataKey = _this$state8.dataKey;
            ...
            switch (modalKey) {
                ...
                case "block-format-adjust":
                    return _react2.default.createElement(_blockFormatAdjust2.default, {
                        onHideModal: _this.handleHideModal,
                        record: record,
                        step: step,
                        mode: mode,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                null,
                                _react2.default.createElement(_comSaveVersion2.default, { versionId: versionId, versionData: versionData,
...
var PlanQuota = function (_Component) {
  ...
  function PlanQuota() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PlanQuota.__proto__ || Object.getPrototypeOf(PlanQuota)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
       ...
       * 发送数据给
       */
    }, _this.postData = {}, _this.GET_FetchData = function (arg) {
      //测试数据减损
      var th = _this;
      _iss2.default.fetch({ url: "/AreaInfo/ISaveAreaPlanInfo", data: { "projectId": "d068e21e-5c2f-a0c0-1dbf-39f50bc7812c" } }).then(function (arg) {
        // console.log("arg.row",arg.rows)
        th.setState({
          "DynamicData": arg.rows
        });
      });
    }, _this.BIND_CALLBACK = function (da, e) {
      //子页面返回callback
      // if(this.time){ clearTimeout(this.time) }
      var th = _this;
      var el = e && e["target"] ? e.target.value : e,
      ...
      var newList = _utils.knife.SET_CountExec(list); //通用计算

      th.setState({
        "DynamicData": newList
      });

      _this.postData = newList.filter(function (arg) {
        //过滤传入所有已填数据
        if (arg["val"]) {
          delete arg["parent"];
          delete arg["child"];
      ...
      _this.props["onPlanQuotaDataChange"] && _this.props.onPlanQuotaDataChange(_this.postData);

      // let validates = knife.valid(list);  //数据校验
      //console.log(validates);
    }, _this.EVENT_ClickSave = function (arg) {
      //  let detaileData = this.postData.filter(arg=>{ if(arg["val"]){ delete arg["parent"];delete arg["child"];return arg} }); //数据

      var _data_ = _this.postData.map(function (arg, ind) {
        return {
          "id": arg["id"],
          "val": arg["val"],
          "label": arg["label"],
          ...
          versionId = "e2f23b9a-31e4-821d-25cf-22c46927e1b8",
          //分期或版本id
      step = "2",
          //阶段
...
var BlockFormatEdit = function (_Component) {
    ...
    function BlockFormatEdit() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BlockFormatEdit.__proto__ || Object.getPrototypeOf(BlockFormatEdit)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            _services.AreaService.getSearchData(step, mode, versionId).then(function (rows) {
                _this.setState({
            ...
            render: function render(text, record) {
                return _react2.default.createElement(_common.WrapperSelect, { dataSource: _this.props.conditionData.land, value: text, showDefault: false,
                    onChange: _this.handleChangeProperty(record, "landid") });
            }
        }, {
            title: '产权属性',
            ...
            render: function render(text, record) {
                return _react2.default.createElement(
                    'a',
                    { href: 'javascript:;', onClick: _this.handleDelete(text) },
                    '\u5220\u9664'
                );
            }
            ...
            return function () {
                ...
                var remain = dataSource.filter(function (item) {
                    return item.id !== id;
                });
                _this.setState({
                    dataSource: [].concat(_toConsumableArray(remain))
                });
            };
            ...
            var paramsValue = {
                ...
                versionId: versionId,
                dataKey: dataKey,
                formData: dataSource.map(function (item) {
                    return {
                        id: item.id,
                        landid: item.landid,
            ...
            _services.AreaService.saveFormatData(paramsValue).then(function (result) {
                if (result === "success") {
                    ...
                    _this.props.onHideModal && _this.props.onHideModal("reload");
                } else {
...
var SaveVersion = function (_Component) {
    ...
    function SaveVersion() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SaveVersion.__proto__ || Object.getPrototypeOf(SaveVersion)).call.apply(_ref, [this].concat(args))), _this), _this.handleSave = function () {
            _this.props.onSaveVersionData && _this.props.onSaveVersionData();
        }, _this.handleChange = function (value) {
    ...
    _createClass(SaveVersion, [{
        ...
        value: function render() {
            ...
            var currentVersion = versionData.filter(function (item) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { type: 'button', className: 'jh_btn jh_btn28 jh_btn_save Left', onClick: this.handleSave },
                    '\u4FDD\u5B58'
                ),
                _react2.default.createElement(
                    'div',
                ...
                _react2.default.createElement(
                    ...
                    '\u72B6\u6001 ',
                    currentVersion ? currentVersion["statusName"] : ""
                )
            );
        }
    }]);
...
SaveVersion.propTypes = {
    ...
    versionId: _react2.default.PropTypes.string, //当前版本
    onVersionChange: _react2.default.PropTypes.func, //版本选择项发生改变时
    onSaveVersionData: _react2.default.PropTypes.func //保存当前版本的规划方案指标数据
};
SaveVersion.defaultProps = {
    versionData: [],
    versionId: "",
    onVersionChange: function onVersionChange() {},
    onSaveVersionData: function onSaveVersionData() {}
};
