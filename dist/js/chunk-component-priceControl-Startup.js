...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* 价格管理-启动会 */
//兼容ie


//标签

var PriceStartup = function (_React$Component) {
    _inherits(PriceStartup, _React$Component);

    function PriceStartup(arg) {
        _classCallCheck(this, PriceStartup);

        // this.props.location.state;
        var _this = _possibleConstructorReturn(this, (PriceStartup.__proto__ || Object.getPrototypeOf(PriceStartup)).call(this, arg));
